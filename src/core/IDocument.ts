...
export const IContentSchema = z.union([z.string(), z.instanceof(Buffer)]).describe("The content of the document");
export type IContent = z.infer<typeof IContentSchema>;

export const IMetadataSchema = z.record(z.string(), z.any()).default({}).describe("The metadata of the document");
export type IMetadata = z.infer<typeof IMetadataSchema>;

export const IVectorSchema = z.number().array().optional().describe("The vector of the document");
